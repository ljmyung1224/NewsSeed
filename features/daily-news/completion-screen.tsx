...
export function CompletionScreen({ xp, streak, earnedXp, completedCount, totalCount, onHome }: { xp: number; streak: number; earnedXp: number; completedCount: number; totalCount: number; onHome: () => void }) {
