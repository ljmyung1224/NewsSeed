      ...
      <div className="grid gap-6 lg:grid-cols-[1.35fr_0.85fr]">
        <div className="space-y-6">
          <section className="relative overflow-hidden rounded-[28px] bg-[var(--green-deep)] p-6 text-white shadow-[0_8px_0_#174b2f] sm:p-8">
            ...
            <div className="relative"><div className="flex items-start justify-between"><div><p className="text-xs font-extrabold tracking-[0.12em] text-[#a9dabb]">TODAY&apos;S NEWSEED</p><h2 className="type-display mt-2 text-[32px] sm:text-[40px]">오늘의 뉴씨드</h2></div><span className="grid h-16 w-16 place-items-center rounded-[22px] bg-white/10 text-3xl">{allDone ? "🌳" : "🌱"}</span></div>
              ...
              <button onClick={onStart} className="type-display mt-5 flex w-full items-center justify-center gap-2 rounded-2xl bg-[#a8e778] px-5 py-4 text-[17px] text-[#164a2f] shadow-[0_4px_0_#6caf52] transition hover:bg-[#b5ed89] active:translate-y-1 active:shadow-none">{allDone ? "오늘의 신문 다시 보기" : completed.length ? "이어서 읽기" : "오늘의 신문 시작하기"}<ArrowIcon size={19}/></button>
            </div>
          </section>
